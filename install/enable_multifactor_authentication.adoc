...
如需疑難排解資訊、請參閱 https://kb.netapp.com/mgmt/SnapCenter/SnapCenter_MFA_login_error_The_SAML_message_response_1_doesnt_match_the_expected_response_2["在多個索引標籤中登入 SnapCenter 會顯示 MFA 錯誤"]
